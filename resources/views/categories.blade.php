        ...
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div id="categoryAlert"
                ...
                <button
                    ...
                    data-dismiss-target="#categoryAlert"
                    aria-label="Close">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            <th scope="col" class="px-4 py-3">{{ __('Category Name') }}</th>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">{{ \Carbon\Carbon::parse($category->created_at)->toDateTimeString()
                                }}
                            </td>
                            <td class="px-4 py-3">{{ \Carbon\Carbon::parse($category->updated_at)->toDateTimeString()
                                }}
                            </td>
                        </tr>
                        @endforeach
                ...
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                    Per Page:
                    <span class="font-semibold text-gray-900 dark:text-white">{{ $categories->perPage() }}</span>
                    | Total:
                    <span class="font-semibold text-gray-900 dark:text-white">{{ $categories->total() ?? 0}}</span>
                </span>
                ...
                <div id="addCategoryModal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <!-- Modal body -->
                            <form class="p-4 md:p-5" action="{{route('fruit.category.store')}}" method="POST">
                                @csrf
                                <div class="grid gap-4 mb-4 grid-cols-2">
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" name="name" id="name" value="{{old('name')}}"
                                               ...
                                               placeholder="{{__('Type category name') }}" required="">
                                    </div>
                                </div>
                                <button type="submit"
